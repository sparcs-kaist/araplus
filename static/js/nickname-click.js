...
function links(e){
    return e.getElementsByClassName("nickname-link");
};


var recipient = "";
function modalopen(nickname){
    var modal = $('#message-modal');
    document.getElementsByClassName("modal-title")[0].innerHTML = nickname + "에게 쪽지 보내기";
    recipient = nickname;
    modal.modal();
};
...
$(document).ready(function(){
    ...
    for ( var i = 0 ; i < nicknames.length; i++ ) {
        ...
        nick.innerHTML = nickname + "<div class='nickname-link'><ul>"
            + "<li><a href='/board/all/?nickname=" + nickname + "' >작성 글 보기</a></li>"
            + "<li><a href='javascript:modalopen(" + '"' + nickname + '"' + ")'>쪽지 보내기</a></li>"
        + "</ul></div>";
        
    }

    $('.nickname-click').mouseover(function(){
        this.style.textDecoration = "underline";
        document.body.style.cursor = "pointer";
    });
    $('.nickname-click').mouseout(function(){
    ...
    $(document).click(function(e){
        ...
        for ( var i = 0; i < elements.length; i++ ) {
            var td = elements[i]
            if ( $(links(td)[0]).hasClass("display-block")){
                fadeOut(links(td)[0]);
            };
        };
    });

    $('.nickname-click').click(function(e){
        e.stopPropagation();
        if ( $(links(this)[0]).hasClass("display-block")){
            ...
            for ( var i = 0; i < elements.length; i++ ) {
                var td = elements[i]
                if ( $(links(td)[0]).hasClass("display-block") && td!==this){
                    fadeOut(links(td)[0]);
                };
            };
