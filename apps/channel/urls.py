...
urlpatterns = [
    ...
    url(r'^(?P<channel_url>[A-z]*)/$', 'apps.channel.views.view_channel'),
    url(r'^(?P<channel_url>[A-z]*)/write/$', 'apps.channel.views.write_post'),
    url(r'^(?P<channel_url>[A-z]*)/(?P<channel_post_id>[1-9][0-9]*)/$',
        'apps.channel.views.read_post'),
    url(r'^(?P<channel_url>[A-z]*)/(?P<channel_post_id>[1-9][0-9]*)/edit/$',
        'apps.channel.views.edit_post'),
    url(r'^(?P<channel_url>[A-z]*)/(?P<channel_post_id>[1-9][0-9]*)/delete$',
